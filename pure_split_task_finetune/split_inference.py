...
if __name__ == "__main__":
    ...
    parser.add_argument("--general_ckpt", type=str, default="/content/llava-v1.5-7b-task-lora-general/")
    parser.add_argument("--regional_ckpt", type=str, default="/content/llava-v1.5-7b-task-lora-regional/")
